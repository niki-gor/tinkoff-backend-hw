...
class Table:
    def __init__(self, columns: list, rows: int):
        self.columns = columns
        self.rows = rows
        cols = len(columns)
        self.table = [[None for j in range(cols)] for i in range(rows)]
